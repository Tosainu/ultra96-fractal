...
proc create_hier_cell_to_live_video { parentCell nameHier } {
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconstant_0/dout] [get_bd_pins xlconcat_0/In0] [get_bd_pins xlconcat_0/In2] [get_bd_pins xlconcat_0/In4]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins xlslice_g/Dout] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net xlslice_b_Dout [get_bd_pins xlslice_b/Dout] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net xlslice_r_Dout [get_bd_pins xlslice_r/Dout] [get_bd_pins xlconcat_0/In5]
  ...
  if { [catch {set fractal_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property CONFIG.NUM_PARALLELS {29} $fractal_0
  ...
  set_property CONFIG.NUM_SI {1} $smartconnect_hp0
  ...
  set_property CONFIG.NUM_SI {1} $smartconnect_hp1
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins axi_interconnect_hpm0/ACLK] [get_bd_pins axi_interconnect_hpm0/S00_ACLK] [get_bd_pins axi_interconnect_hpm0/M00_ACLK] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins fractal_0/aclk] [get_bd_pins axis_clock_converter_0/s_axis_aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins rst_clk_wiz_0_300M/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins axi_interconnect_hpm1/ACLK] [get_bd_pins axi_interconnect_hpm1/S00_ACLK] [get_bd_pins axi_interconnect_hpm1/M00_ACLK] [get_bd_pins axi_interconnect_hpm1/M01_ACLK] [get_bd_pins smartconnect_hp0/aclk] [get_bd_pins smartconnect_hp1/aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk] [get_bd_pins axis_subset_converter_1/aclk] [get_bd_pins axis_clock_converter_0/m_axis_aclk] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins rst_clk_wiz_0_150M/slowest_sync_clk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_tc_0/s_axi_aclk]
  ...
  connect_bd_net -net rst_clk_wiz_0_150M_interconnect_aresetn [get_bd_pins rst_clk_wiz_0_150M/interconnect_aresetn] [get_bd_pins axi_interconnect_hpm1/ARESETN]
  connect_bd_net -net rst_clk_wiz_0_150M_peripheral_aresetn [get_bd_pins rst_clk_wiz_0_150M/peripheral_aresetn] [get_bd_pins axi_interconnect_hpm1/S00_ARESETN] [get_bd_pins axi_interconnect_hpm1/M00_ARESETN] [get_bd_pins axi_interconnect_hpm1/M01_ARESETN] [get_bd_pins smartconnect_hp0/aresetn] [get_bd_pins smartconnect_hp1/aresetn] [get_bd_pins axis_subset_converter_1/aresetn] [get_bd_pins axis_clock_converter_0/m_axis_aresetn] [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_tc_0/s_axi_aresetn]
  connect_bd_net -net rst_clk_wiz_0_300M_interconnect_aresetn [get_bd_pins rst_clk_wiz_0_300M/interconnect_aresetn] [get_bd_pins axi_interconnect_hpm0/ARESETN]
  connect_bd_net -net rst_clk_wiz_0_300M_peripheral_aresetn [get_bd_pins rst_clk_wiz_0_300M/peripheral_aresetn] [get_bd_pins axi_interconnect_hpm0/S00_ARESETN] [get_bd_pins axi_interconnect_hpm0/M00_ARESETN] [get_bd_pins fractal_0/aresetn] [get_bd_pins axis_clock_converter_0/s_axis_aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn]
  ...
  connect_bd_net -net v_axi4s_vid_out_0_vid_data [get_bd_pins v_axi4s_vid_out_0/vid_data] [get_bd_pins to_live_video/Din]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_dp_video_ref_clk [get_bd_pins zynq_ultra_ps_e_0/dp_video_ref_clk] [get_bd_pins zynq_ultra_ps_e_0/dp_video_in_clk] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_clk] [get_bd_pins v_tc_0/clk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0] [get_bd_pins rst_clk_wiz_0_150M/ext_reset_in] [get_bd_pins rst_clk_wiz_0_300M/ext_reset_in]
