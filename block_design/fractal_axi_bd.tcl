...
# fractal_axi
  ...
  set design_name fractal_axi_bd
  ...
  set block_cell_name fractal_axi_0
  if { [catch {set fractal_axi_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $fractal_axi_0 eq "" } {
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A00000 [get_bd_addr_spaces axi_vip_0/Master_AXI] [get_bd_addr_segs fractal_axi_0/S_AXI/reg0] SEG_fractal_axi_0_reg0
